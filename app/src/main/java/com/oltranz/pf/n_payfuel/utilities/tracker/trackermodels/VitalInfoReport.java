...
public class VitalInfoReport {
    ...
    public VitalInfoReport() {
    }

    public VitalInfoReport(MBattery battery, MHardware hardware, MSoftware software, MGps gps, MNetwork network) {
